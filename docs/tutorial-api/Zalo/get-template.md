...
:::tip API
  `POST` __$BASE_URL__/api/vendor/v1/zalo/get-template
:::
...
| created_at         | string          |    Thời gian cập nhật   |
| preview_url         | string          |    Thời gian tạo   |
...
| template_params         | object          |    Danh sách các thuộc tính của mẫu tin   |
